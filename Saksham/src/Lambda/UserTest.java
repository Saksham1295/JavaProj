...
public class UserTest {
  ...
  private static void newJavaWay() {
    ...
    Collections.sort(users,  (User u1, User u2) -> u1.getFirstName().compareTo(u2.getFirstName()));
    printListNewWay("by FirstName");

    Collections.sort(users,  (User u1, User u2) -> u1.getLastName().compareTo(u2.getLastName()));
    printListNewWay("by LastName");

    Collections.sort(users, (User u1, User u2) -> u1.getAge().compareTo(u2.getAge()));
